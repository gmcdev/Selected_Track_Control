...
auto_arm = True # default behaviour for auto-arming a track on selection, either False or True
...
midi_mapping = {
	...
	"play_selected_clip": CC(20, TRIGGER),  # (Note(43), NoteOff(43)), # listen to "Note Off" as well, to support clip-launch mode "Gate"
	"toggle_selected_clip": CC(21),
